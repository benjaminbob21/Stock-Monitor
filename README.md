...
A personal, **ML-powered stock research tool**. It scans the market, scores each stock's conviction with a transparent explanation of *why*, and sends alerts — so investment research doesn't require constant manual effort.
